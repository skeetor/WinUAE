...
void OutputBar::AdjusrHorzScroll(CListBox& wndListBox)
{
	CClientDC dc(this);
...
void OutputBar::FillBuildWindow()
{
...
void OutputBar::FillDebugWindow()
{
...
BEGIN_MESSAGE_MAP(OutputList1, CListBox)
...
void OutputList1::OnWindowPosChanging(WINDOWPOS FAR* lpwndpos)
{
...
void OutputList1::OnContextMenu(CWnd* /*pWnd*/, CPoint point)
{
	CMenu menu;
...
void OutputList1::OnEditCopy()
{
	MessageBox(_T("Copy output"));
}

void OutputList1::OnEditClear()
{
	MessageBox(_T("Clear output"));
}

void OutputList1::OnOutputGotoError()
{
}

void OutputList1::OnViewOutput()
{

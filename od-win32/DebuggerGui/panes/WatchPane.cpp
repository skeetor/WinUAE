...
BEGIN_MESSAGE_MAP(WatchPane, CDockablePane)
	ON_WM_CREATE()
	ON_WM_SIZE()
	ON_WM_PAINT()
	ON_WM_SETFOCUS()
...
int WatchPane::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void WatchPane::OnSize(UINT nType, int cx, int cy)
{
...
void WatchPane::OnSetFocus(CWnd* pOldWnd)
{

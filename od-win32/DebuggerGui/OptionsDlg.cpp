...
IMPLEMENT_DYNAMIC(OptionsDlg, CMFCPropertySheet)

OptionsDlg::OptionsDlg(LPCTSTR pszCaption, CWnd* pParentWnd, UINT iSelectPage)
...
BEGIN_MESSAGE_MAP(OptionsDlg, CMFCPropertySheet)
END_MESSAGE_MAP()

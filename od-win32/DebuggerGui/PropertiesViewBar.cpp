...
PropertiesViewBar::PropertiesViewBar()
{
}
...
BEGIN_MESSAGE_MAP(PropertiesViewBar, CDockablePane)
	ON_WM_CREATE()
	ON_WM_SIZE()
...
void PropertiesViewBar::AdjustLayout()
{
	if (GetSafeHwnd() == NULL)
	{
		return;
...
int PropertiesViewBar::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void PropertiesViewBar::OnSize(UINT nType, int cx, int cy)
{
	CDockablePane::OnSize(nType, cx, cy);
	AdjustLayout();
}

void PropertiesViewBar::OnSortingprop()
{
	m_wndPropList.SetAlphabeticMode();
}

void PropertiesViewBar::OnUpdateSortingprop(CCmdUI* pCmdUI)
{
	pCmdUI->SetCheck(m_wndPropList.IsAlphabeticMode());
}

void PropertiesViewBar::OnExpand()
{
	m_wndPropList.SetAlphabeticMode(FALSE);
}

void PropertiesViewBar::OnUpdateExpand(CCmdUI* pCmdUI)
{
	pCmdUI->SetCheck(!m_wndPropList.IsAlphabeticMode());
}

void PropertiesViewBar::OnProperies1()
{
}

void PropertiesViewBar::OnUpdateProperies1(CCmdUI* /*pCmdUI*/)
{
}

void PropertiesViewBar::OnProperies2()
{
}

void PropertiesViewBar::OnUpdateProperies2(CCmdUI* /*pCmdUI*/)
{
}

void PropertiesViewBar::InitPropList()
{
	SetPropListFont();
...
void PropertiesViewBar::OnSetFocus(CWnd* pOldWnd)
{
...
void PropertiesViewBar::OnSettingChange(UINT uFlags, LPCTSTR lpszSection)
{
	CDockablePane::OnSettingChange(uFlags, lpszSection);
	SetPropListFont();
}

void PropertiesViewBar::SetPropListFont()
{
...
void PropertiesViewBar::OnChangeVisualStyle()
{
	m_wndToolBar.CleanUpLockedImages();
	m_wndToolBar.LoadBitmap(DebuggerGuiApp::getInstance().m_bHiColorIcons ? IDB_PROP24 : IDR_PROPERTIES, 0, 0, TRUE /* Locked */);
}
